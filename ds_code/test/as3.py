...
while True:
    ...
    print("nChooseK({n:d},{k:d}) , within {times:<5.3f} seconds".format(
        n=i,k=i//2,times=timecost))
    if timecost>=60:
        break
    break
# print("nChooseK({n:d},{k:d}) is {rs:<10.6E}, within {times:<5.2f} seconds".format(
